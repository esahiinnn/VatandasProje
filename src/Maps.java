...
public class Maps {
	...
	*/
    public static void main(String[] args) {
        ...
        Hashtable<Integer, String> hms = new Hashtable<>();
        HashMap<Integer, String> hm1 = new HashMap<>();

        hm1.put(101, "Ali Han");
        hm1.put(102, "Ali Han");
        hm1.put(null, "Veli Can");
        hm1.put(null, "Ali Han");
        hm1.put(103, null);
        System.out.println(hm1);
        hm1.putIfAbsent(103, "Ebubekir SAHIN");
        System.out.println(hm1);
    ...
    public static void replace(Integer key, String value){

        HashMap<Integer, String> hm1 = new HashMap<>();
        if(hm1.containsKey(key)){
            hm1.put(key, value);
        }else{
            System.out.println("Gonderdiginiz key Hashmap'imizde mevcut degildir");
        }
